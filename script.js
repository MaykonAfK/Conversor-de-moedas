var resultado;
     ...
     $.ajax({
       ...
       error: function (data) {
         Swal.fire({
           icon: 'error',
           title: 'Ops',
           text: 'O site não conseguiu carregar os valores atuais da cotação. Tente novamente mais tarde. :('
         });
       }
     });
     ...
     function converter() {
       ...
       function getHorarioAtualizacao(codigoMoeda) {
         ...
         atualizacao.innerHTML = 'Atualizado em ' + dataFormatada;
       }
       ...
       if (isNaN(numeroDigitado) && selecionado === "NULL") {
         Swal.fire({
           icon: 'error',
           title: 'Ops',
           text: 'Digite um valor e escolha uma moeda'
         });
       } else {
       ...
       if (numeroDigitado <= 0) {
         Swal.fire({
           icon: 'error',
           title: 'Ops',
           text: 'Valor inválido! Digite somente valores positivos e diferentes de zero'
         });
       }
